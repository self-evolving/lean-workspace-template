...
.page[data-frame=canvas].canvas-sidebar-open .canvas-sidebar-toggle {
  /* align with the 2rem GitHub action in the sidebar page-title row */
  left: calc(var(--canvas-sidebar-width) - 3rem);
  top: 1rem;
  border: none;
  background: transparent;
}
...
@media (max-width: 800px) {
  ...
  .page[data-frame=canvas].canvas-sidebar-open .canvas-sidebar-toggle {
    left: calc(var(--canvas-sidebar-width) - 44px);
  }
...
.page[data-frame=canvas] .canvas-sidebar .page-title {
  box-sizing: border-box;
...
.page[data-frame=canvas] {
  --canvas-preview-width: clamp(360px, 34vw, 560px);
}
.page[data-frame=canvas] .canvas-sidebar-preview {
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
  z-index: 10000;
  display: none;
  width: min(var(--canvas-preview-width), calc(100vw - 56px));
...
.page[data-frame=canvas] .canvas-sidebar-preview:not([hidden]) {
  display: flex;
}
.page[data-frame=canvas].canvas-sidebar-previewing .canvas-sidebar-preview {
  transform: translateX(0);
}
.page[data-frame=canvas] .canvas-sidebar-preview-resizer {
  position: absolute;
  top: 0;
  bottom: 0;
  left: -5px;
...
.page[data-frame=canvas] .canvas-sidebar-preview-resizer::after {
  content: "";
  position: absolute;
  top: 0.9rem;
  bottom: 0.9rem;
...
.page[data-frame=canvas] .canvas-sidebar-preview-resizer:hover::after,
body.canvas-preview-resizing .canvas-sidebar-preview-resizer::after {
  background: color-mix(in srgb, var(--secondary) 45%, transparent);
}
body.canvas-preview-resizing {
  cursor: ew-resize;
  user-select: none;
}
.page[data-frame=canvas] .canvas-sidebar-preview-bar {
  display: grid;
  ...
  border-bottom: 1px solid var(--lightgray);
  background: color-mix(in srgb, var(--lightgray) 24%, var(--light));
}
.page[data-frame=canvas] .canvas-sidebar-preview-title {
  min-width: 0;
  overflow: hidden;
  color: var(--dark);
  font-size: 0.98rem;
...
.page[data-frame=canvas] .canvas-sidebar-preview-open {
  display: inline-flex;
  align-items: center;
  min-height: 2rem;
  padding: 0 0.55rem;
...
.page[data-frame=canvas] .canvas-sidebar-preview-open:hover {
  background: var(--lightgray);
}
.page[data-frame=canvas] .canvas-sidebar-preview-close {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 2rem;
...
.page[data-frame=canvas] .canvas-sidebar-preview-close:hover {
  background: var(--lightgray);
  color: var(--dark);
}
.page[data-frame=canvas] .canvas-sidebar-preview-content {
  flex: 1 1 auto;
  min-height: 0;
  overflow-y: auto;
...
.page[data-frame=canvas] .canvas-sidebar-preview-content article {
  margin: 0;
}
.page[data-frame=canvas] .canvas-sidebar-preview-content h1 {
  margin-top: 0;
  font-size: 1.18rem;
}
.page[data-frame=canvas] .canvas-sidebar-preview-content h2 {
  font-size: 1.02rem;
}
.page[data-frame=canvas] .canvas-sidebar-preview-content h3 {
  font-size: 0.95rem;
}
.page[data-frame=canvas] .canvas-sidebar-preview-content pre {
  max-width: 100%;
  overflow-x: auto;
}
.page[data-frame=canvas] .canvas-sidebar-preview-status {
  margin: 0;
  color: var(--gray);
}
.page[data-frame=canvas] .canvas-sidebar-target {
  scroll-margin-top: 0.75rem;
  border-radius: 5px;
  background: color-mix(in srgb, var(--secondary) 9%, transparent);
}
.page[data-frame=canvas] .canvas-sidebar-preview-content .bp-label-anchor.canvas-sidebar-target {
  background: none;
}
@media (max-width: 800px) {
  .page[data-frame=canvas] {
    --canvas-preview-width: calc(100vw - 56px);
  }
  .page[data-frame=canvas] .canvas-sidebar-preview {
    width: min(var(--canvas-preview-width), calc(100vw - 56px));
    min-width: 0;
...
.canvas-node-card {
  ...
  border-radius: 10px;
  overflow: hidden;
  background: color-mix(in srgb, var(--canvas-node-color, var(--lightgray)) 7%, var(--light));
}
.canvas-node-card .canvas-card-status {
  background: color-mix(in srgb, var(--canvas-node-color, var(--lightgray)) 14%, var(--light));
}
.canvas-node-card .canvas-card-kind {
  font-size: 0.62rem;
  font-weight: 600;
  text-transform: uppercase;
  letter-spacing: 0.06em;
  color: var(--canvas-node-color, var(--gray));
  white-space: nowrap;
}
.canvas-node-card .canvas-card-title-row {
  display: grid;
...
.canvas-node-card .canvas-card-title {
  min-width: 0;
  width: 100%;
  font-size: 0.86rem;
  font-weight: 700;
...
.canvas-open-sidebar {
  ...
  height: 1.35rem;
  padding: 0;
  border: 1px solid color-mix(in srgb, var(--canvas-node-color, var(--secondary)) 28%, var(--lightgray));
  border-radius: 6px;
  background: color-mix(in srgb, var(--canvas-node-color, var(--secondary)) 8%, var(--light));
  color: var(--canvas-node-color, var(--secondary));
  cursor: pointer;
  opacity: 0.78;
}
.canvas-open-sidebar:hover,
.canvas-open-sidebar:focus-visible {
...
.canvas-node-file .canvas-file-label .canvas-open-sidebar {
  width: 1.2rem;
  height: 1.2rem;
  margin-left: auto;
}
.canvas-node-file .canvas-file-subpath + .canvas-open-sidebar {
  margin-left: 0;
}
.canvas-node-card .canvas-card-status {
  font-size: 0.58rem;
...
.canvas-hovering .canvas-node.hover-neighbor {
  opacity: 1;
}
.canvas-hovering .canvas-node.hover-focus {
...
.canvas-selecting .canvas-node {
  opacity: 0.18;
}
.canvas-selecting .canvas-node.selection-focus,
.canvas-selecting .canvas-node.selection-neighbor {
  opacity: 1;
}
.canvas-selecting .canvas-node.selection-focus {
...
.canvas-controls button.canvas-selection-clear {
  font-size: 0.85rem;
  font-weight: 700;
  line-height: 1;
}
.canvas-controls button.canvas-selection-clear[hidden] {
  display: none;
}
.canvas-controls button.canvas-selection-clear[aria-expanded=true] {
  background: var(--lightgray);
  color: var(--dark);
}
.canvas-selection-panel {
  ...
  max-height: min(240px, calc(100vh - 80px));
  overflow: auto;
  overscroll-behavior: contain;
  touch-action: auto;
...
.canvas-selection-remove:hover {
  background: var(--lightgray);
  color: var(--dark);
}
.canvas-selection-clear-all {
  width: 100%;
...
.canvas-selection-clear-all:hover {
  background: var(--lightgray);
}

/* legend panel (toggled by the controls button) */
.canvas-legend {
  position: fixed;
  top: 12px;
  right: 56px;
...
;(() => {
  const init = () => {
    for (const container of document.querySelectorAll(".canvas-container")) {
      ...
      const edgeEls = Array.from(container.querySelectorAll(".canvas-edge[data-from]"))
      ...
      let selectionControl = container.querySelector(".canvas-selection-clear")
      let selectionPanel = container.querySelector(".canvas-selection-panel")
      if (!selectionControl) {
        const controls = container.querySelector(".canvas-controls")
        if (controls) {
          selectionControl = document.createElement("button")
          selectionControl.type = "button"
          selectionControl.className = "canvas-selection-clear"
      ...
      if (!selectionPanel) {
        ...
        selectionPanel.className = "canvas-selection-panel"
        selectionPanel.hidden = true
        container.append(selectionPanel)
      }
      if (selectionPanel && !selectionPanel.id) {
        selectionPanel.id = "canvas-selection-panel-" + Math.random().toString(36).slice(2)
      }
      if (selectionControl && selectionPanel) {
        selectionControl.setAttribute("aria-controls", selectionPanel.id)
        selectionControl.setAttribute("aria-expanded", "false")
      }
      const nodeLabel = (id, el) => {
        const title = el.querySelector(".canvas-card-title") ?? el.querySelector("a")
        return (title?.textContent ?? el.textContent ?? id).trim() || id
      }
      const selectedItems = () => {
        const items = []
        for (const [id, el] of nodeEls) {
          if (selectedIds.has(id)) items.push({ id, label: nodeLabel(id, el) })
        }
        return items
      }
      const renderSelectionPanel = () => {
        ...
        title.className = "canvas-selection-title"
        title.textContent = items.length === 1 ? "1 selected" : items.length + " selected"
        const list = document.createElement("ul")
        list.className = "canvas-selection-list"
        for (const item of items) {
          ...
          remove.textContent = "×"
          remove.setAttribute("aria-label", "Remove " + item.label + " from selection")
        ...
        clear.type = "button"
        clear.className = "canvas-selection-clear-all"
        clear.textContent = "Clear selection"
        clear.addEventListener("click", (event) => {
          event.stopPropagation()
          clearSelection()
        })
        selectionPanel.replaceChildren(title, list, clear)
      }
      const updateSelectionControl = () => {
        if (!selectionControl) return
        const count = selectedIds.size
        renderSelectionPanel()
        if (count === 0) {
          selectionControl.hidden = true
          selectionControl.textContent = ""
          selectionControl.title = ""
          selectionControl.setAttribute("aria-label", "No selected canvas nodes")
          selectionControl.setAttribute("aria-expanded", "false")
          return
        }
        const label = count === 1 ? "1 selected" : count + " selected"
        selectionControl.hidden = false
        selectionControl.textContent = String(count)
        selectionControl.title = label
        selectionControl.setAttribute("aria-label", label + "; show selection details")
        selectionControl.setAttribute("aria-expanded", selectionPanel && !selectionPanel.hidden ? "true" : "false")
      }
      const toggleSelectionPanel = () => {
        if (!selectionPanel || selectedIds.size === 0) return
      ...
      const ignoredTarget = (target) => Boolean(target.closest("a, button, .canvas-legend, .canvas-selection-panel, .canvas-controls"))
      const rememberPointer = (event) => {
        if (event.button !== 0) return
        const target = event.target instanceof Element ? event.target : null
        const node = target?.closest(".canvas-node[data-node-id]")
        pointerStart = {
          x: event.clientX,
          y: event.clientY,
          moved: false,
          ignored: target ? ignoredTarget(target) : false,
      ...
      const finishPointer = (event) => {
        trackPointer(event)
        clickPointer = pointerStart
        if (pointerStart?.moved) suppressClickUntil = Date.now() + 120
      ...
      const handleClick = (event) => {
        ...
        const target = event.target instanceof Element ? event.target : null
        if (!target) return
        const pointer = clickPointer
        clickPointer = undefined
        if (Date.now() < suppressClickUntil || pointer?.ignored || ignoredTarget(target)) return
        const node = target.closest(".canvas-node[data-node-id]")
        const id = node?.dataset.nodeId ?? pointer?.nodeId
      ...
      cleanupFns.push(() => {
        ...
        selectionControl?.removeEventListener("click", toggleSelectionPanel)
      })
      updateSelectionControl()
      if (typeof window !== "undefined" && window.addCleanup) {
        window.addCleanup(() => {
          ...
          container.dataset.hoverInit = "false"
        })
      }
    }
  }
...
`;
// local patch: legend panel toggle
canvas_inline_default += `
;(() => {
  const init = () => {
    for (const container of document.querySelectorAll(".canvas-container")) {
      const btn = container.querySelector(".canvas-legend-toggle")
      const panel = container.querySelector(".canvas-legend")
      if (!btn || !panel || btn.dataset.legendInit === "true") continue
      btn.dataset.legendInit = "true"
...
`;
// local patch: open canvas file-card pages in a resizable right sidebar
canvas_inline_default += `
;(() => {
  const ensurePreview = (page) => {
    let preview = page.querySelector(".canvas-sidebar-preview")
    if (preview) return preview
    preview = document.createElement("section")
    preview.className = "canvas-sidebar-preview"
    preview.hidden = true
    preview.setAttribute("aria-live", "polite")
    const resizer = document.createElement("div")
    resizer.className = "canvas-sidebar-preview-resizer"
    resizer.setAttribute("role", "separator")
    resizer.setAttribute("aria-orientation", "vertical")
    resizer.setAttribute("aria-label", "Resize sidebar preview")
    const bar = document.createElement("div")
    bar.className = "canvas-sidebar-preview-bar"
    const title = document.createElement("div")
    title.className = "canvas-sidebar-preview-title"
    const open = document.createElement("a")
    open.className = "canvas-sidebar-preview-open"
    open.textContent = "Open ↗"
    const close = document.createElement("button")
    close.type = "button"
    close.className = "canvas-sidebar-preview-close"
    close.textContent = "×"
    close.setAttribute("aria-label", "Close sidebar preview")
    const content = document.createElement("div")
    content.className = "canvas-sidebar-preview-content"
    content.tabIndex = 0
    bar.append(title, open, close)
    preview.append(resizer, bar, content)
    page.append(preview)
    return preview
  }
  const toDisplayHref = (url) => url.origin === window.location.origin ? url.pathname + url.search + url.hash : url.href
  const rebaseUrl = (value, base) => {
    if (!value || /^(data|mailto|tel|javascript):/i.test(value)) return value
    try {
      return toDisplayHref(new URL(value, base))
    } catch {
      return value
    }
  }
  const rebaseSrcset = (value, base) => value.split(",").map((part) => {
    const bits = part.trim().split(/\\s+/)
    if (!bits[0]) return part
    bits[0] = rebaseUrl(bits[0], base)
    return bits.join(" ")
  }).join(", ")
  const rebaseContent = (root, base) => {
    for (const el of root.querySelectorAll("a[href]")) el.setAttribute("href", rebaseUrl(el.getAttribute("href"), base))
    for (const el of root.querySelectorAll("img[src], iframe[src], video[src], audio[src], source[src]")) el.setAttribute("src", rebaseUrl(el.getAttribute("src"), base))
    for (const el of root.querySelectorAll("img[srcset], source[srcset]")) el.setAttribute("srcset", rebaseSrcset(el.getAttribute("srcset"), base))
  }
  const findHashTarget = (root, hash) => {
    if (!hash) return null
    let id = hash.slice(1)
    try {
      id = decodeURIComponent(id)
    } catch {}
    return Array.from(root.querySelectorAll("[id], a[name]")).find((el) => el.id === id || el.getAttribute("name") === id) ?? null
  }
  const visibleHashTarget = (target) => {
    if (!target) return null
    if (target.classList?.contains("bp-label-anchor")) {
      const heading = target.nextElementSibling
      if (heading?.matches("h1,h2,h3,h4,h5,h6")) return heading
    }
    return target
  }
  const init = () => {
    for (const container of document.querySelectorAll(".canvas-container")) {
      if (container.dataset.sidebarPreviewInit === "true") continue
      container.dataset.sidebarPreviewInit = "true"
      const page = container.closest('.page[data-frame="canvas"]')
      if (!page) continue
      const preview = ensurePreview(page)
      const close = preview.querySelector(".canvas-sidebar-preview-close")
      const resizer = preview.querySelector(".canvas-sidebar-preview-resizer")
      const titleEl = preview.querySelector(".canvas-sidebar-preview-title")
      const openEl = preview.querySelector(".canvas-sidebar-preview-open")
      const contentEl = preview.querySelector(".canvas-sidebar-preview-content")
      const cleanupFns = []
      let requestSeq = 0
      let currentLoadController
      const showStatus = (message) => {
        const status = document.createElement("p")
        status.className = "canvas-sidebar-preview-status"
        status.textContent = message
        contentEl.replaceChildren(status)
      }
      const showPreview = () => {
        preview.hidden = false
        page.classList.add("canvas-sidebar-previewing")
      }
      const closePreview = () => {
        requestSeq++
        currentLoadController?.abort()
        currentLoadController = undefined
        page.classList.remove("canvas-sidebar-previewing")
        preview.hidden = true
      }
      const load = async (href, fallbackTitle) => {
        ...
        showPreview()
        titleEl.textContent = fallbackTitle || target.pathname
        openEl.href = toDisplayHref(target)
        openEl.target = "_self"
        openEl.removeAttribute("rel")
        showStatus("Loading…")
        try {
          ...
          const source = doc.querySelector(".center article.popover-hint") ?? doc.querySelector("article.popover-hint") ?? doc.querySelector(".popover-hint") ?? doc.querySelector("article") ?? doc.body
          const clone = source.cloneNode(true)
          for (const el of clone.querySelectorAll("script, style, link[rel='stylesheet']")) el.remove()
          rebaseContent(clone, fetchUrl.href)
          const docTitle = doc.querySelector("h1.article-title")?.textContent?.trim() || doc.querySelector("h1")?.textContent?.trim() || doc.title || fallbackTitle || target.pathname
          if (requestId !== requestSeq) return
          titleEl.textContent = fallbackTitle || docTitle
          contentEl.replaceChildren(clone)
          const hashTarget = visibleHashTarget(findHashTarget(contentEl, target.hash))
          if (hashTarget) {
            requestAnimationFrame(() => {
              if (requestId !== requestSeq) return
              contentEl.querySelectorAll(".canvas-sidebar-target").forEach((el) => el.classList.remove("canvas-sidebar-target"))
              hashTarget.classList.add("canvas-sidebar-target")
          ...
          if (requestId !== requestSeq || error?.name === "AbortError") return
          console.warn("canvas sidebar preview: failed to load", target.href, error)
          showStatus("Could not load this page in the sidebar.")
        } finally {
          if (requestId === requestSeq && currentLoadController === controller) {
            currentLoadController = undefined
          }
        }
      }
      const handleButtonClick = (event) => {
        const target = event.target instanceof Element ? event.target : null
        const btn = target?.closest(".canvas-open-sidebar")
        if (!btn || !container.contains(btn)) return
        event.preventDefault()
        event.stopPropagation()
        const href = btn.getAttribute("data-href")
        if (href) load(href, btn.getAttribute("data-title") || btn.getAttribute("aria-label") || "")
      }
      const handleContentClick = (event) => {
        if (event.defaultPrevented || event.metaKey || event.ctrlKey || event.shiftKey || event.altKey) return
        const target = event.target instanceof Element ? event.target : null
        const link = target?.closest("a[href]")
        if (!link || !contentEl.contains(link) || link.hasAttribute("download")) return
        const url = new URL(link.href, window.location.href)
        if (url.origin !== window.location.origin || (link.target && link.target !== "_self")) return
        event.preventDefault()
        event.stopPropagation()
        load(toDisplayHref(url), link.textContent?.trim() || url.pathname)
      }
      let resizing = false
      let resizePointerId
      let resizeStartX = 0
      ...
      const clampWidth = (width) => {
        const available = Math.max(240, window.innerWidth - 56)
        const min = Math.min(320, available)
        return Math.max(min, Math.min(available, width))
      }
      const startResize = (event) => {
        ...
        resizeStartWidth = preview.getBoundingClientRect().width
        document.body.classList.add("canvas-preview-resizing")
        resizer.setPointerCapture?.(event.pointerId)
      }
      const moveResize = (event) => {
        if (!resizing) return
        event.preventDefault()
        const width = clampWidth(resizeStartWidth + resizeStartX - event.clientX)
        page.style.setProperty("--canvas-preview-width", width + "px")
      }
      const stopResize = () => {
        if (!resizing) return
        resizing = false
        document.body.classList.remove("canvas-preview-resizing")
      ...
      if (typeof window !== "undefined" && window.addCleanup) {
        window.addCleanup(() => {
          for (const cleanup of cleanupFns) cleanup()
          container.dataset.sidebarPreviewInit = "false"
          document.body.classList.remove("canvas-preview-resizing")
        })
      }
    }
...
function renderNode(node, renderedTexts, slug2, allFiles, visited) {
  ...
  switch (node.type) {
    ...
    case "file": {
      ...
      const fileHref = resolveRelative(slug2, fileSlug);
      const exactHref = fileHref + (node.subpath ?? "");
      ...
      if (isImage) {
        return /* @__PURE__ */ u2(
          "div",
          {
            ...
            style: styleStr,
            children: /* @__PURE__ */ u2("img", { src: fileHref, alt: filename, loading: "lazy" })
          }
        );
      }
      // blueprint-as-source: self-describing cards — node carries its own title/kind/
      // status (items live as anchors inside chapter pages, so there is no per-item
      // page to look up); the link lands on the item's heading via the subpath.
      if (node.bpTitle) {
        const title = node.bpName ?? node.bpTitle;
      ...
      const cardPage = findPage(fileSlug, allFiles);
      const cardFm = cardPage?.frontmatter;
      if (cardFm && cardFm.blueprint_label && !node.subpath) {
        const cardTitle = String(cardFm.title ?? filename);
        const sepIdx = cardTitle.indexOf(" · ");
        const kindLine = sepIdx > 0 ? cardTitle.slice(0, sepIdx) : String(cardFm.type ?? "");
        const nameLine = sepIdx > 0 ? cardTitle.slice(sepIdx + 3) : cardTitle;
        return /* @__PURE__ */ u2("div", { class: "canvas-node canvas-node-file canvas-node-card", "data-node-id": node.id, style: styleStr, children: [
      ...
      return /* @__PURE__ */ u2("div", { class: "canvas-node canvas-node-file", "data-node-id": node.id, style: styleStr, children: [
        /* @__PURE__ */ u2("div", { class: "canvas-file-label", children: [
          ...
          renderSidebarButton(exactHref, filename)
        ] }),
...
function computeAnchorPlan(edges, nodeMap) {
  ...
  for (const edge of edges) {
    ...
    add(`${edge.fromNode}|${edge.fromSide ?? "c"}`, {
      edge,
      end: "from",
      node: fromNode,
      side: edge.fromSide,
      other: getEdgeAnchor(toNode, edge.toSide)
    });
    add(`${edge.toNode}|${edge.toSide ?? "c"}`, {
      edge,
      end: "to",
      node: toNode,
      side: edge.toSide,
      other: getEdgeAnchor(fromNode, edge.fromSide)
    });
  }
  const plan = /* @__PURE__ */ new Map();
  for (const entries of groups.values()) {
    const side = entries[0].side;
    if (!side || entries.length < 2) continue;
    const horizontal = side === "top" || side === "bottom";
    entries.sort((a, b) => horizontal ? a.other.x - b.other.x : a.other.y - b.other.y);
    const step = Math.min(0.7 / Math.max(entries.length - 1, 1), 0.18);
    entries.forEach((entry, i) => {
      const t = 0.5 + (i - (entries.length - 1) / 2) * step;
      const base = getEdgeAnchor(entry.node, side);
      const pos = horizontal
        ? { x: entry.node.x + entry.node.width * t, y: base.y }
        : { x: base.x, y: entry.node.y + entry.node.height * t };
      const rec = plan.get(entry.edge.id) ?? {};
      rec[entry.end] = pos;
      plan.set(entry.edge.id, rec);
    });
  }
  return plan;
}
...
function renderEdge(edge, nodeMap, anchorPlan, markerPlan) {
  ...
  const planned = anchorPlan?.get(edge.id);
  const from = planned?.from ?? getEdgeAnchor(fromNode, edge.fromSide);
  const to = planned?.to ?? getEdgeAnchor(toNode, edge.toSide);
  ...
  const bend = Math.max(24, Math.min(150, dist * 0.35));
...
function renderLegend(legend) {
  const swatchStyle = (color) => {
    const c = resolveColor(color ?? void 0) ?? "var(--lightgray)";
    return `border-color:${c};background:color-mix(in srgb, ${c} 12%, var(--light))`;
  };
  const edgeSampleStyle = (e) => {
    const c = resolveColor(e.color ?? void 0) ?? "var(--gray)";
    return `border-top:2px ${e.dashed ? "dashed" : "solid"} ${c}`;
  };
  return /* @__PURE__ */ u2("div", { class: "canvas-legend", hidden: true, children: [
    legend.title && /* @__PURE__ */ u2("div", { class: "canvas-legend-title", children: legend.title }),
    (legend.nodes ?? []).length > 0 && /* @__PURE__ */ u2("ul", { class: "canvas-legend-list", children: legend.nodes.map(
      (n) => /* @__PURE__ */ u2("li", { children: [
        /* @__PURE__ */ u2("span", { class: "canvas-legend-swatch", style: swatchStyle(n.color) }),
        /* @__PURE__ */ u2("span", { children: n.label })
      ] })
    ) }),
    (legend.edges ?? []).length > 0 && /* @__PURE__ */ u2("ul", { class: "canvas-legend-list", children: legend.edges.map(
      (e) => /* @__PURE__ */ u2("li", { children: [
        /* @__PURE__ */ u2("span", { class: "canvas-legend-edge", style: edgeSampleStyle(e) }),
        /* @__PURE__ */ u2("span", { children: e.label })
      ] })
    ) }),
    legend.note && /* @__PURE__ */ u2("div", { class: "canvas-legend-note", children: legend.note })
  ] });
}
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ u2("div", { class: "canvas-controls", children: [
            ...
            canvasData.legend && /* @__PURE__ */ u2("button", { class: "canvas-legend-toggle", type: "button", "aria-label": "Toggle legend", children: /* @__PURE__ */ u2(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
                width: "16",
                ...
                children: [
                  ...
                  /* @__PURE__ */ u2("path", { d: "M12 16v-4" }),
                  /* @__PURE__ */ u2("path", { d: "M12 8h.01" })
                ]
              }
            ) }),
            /* @__PURE__ */ u2("button", { class: "canvas-selection-clear", type: "button", "aria-label": "Clear selected canvas nodes", hidden: true, children: "Clear selection" })
          ] }),
          canvasData.legend && renderLegend(canvasData.legend),
...
/* the theme pads the whole body (decorative dotted background offset);
   canvas pages should reach the viewport top */
body[data-slug$=".canvas"] {
  padding-top: 0;
}
...
`,
  render({ componentData, pageBody: Content, afterBody, left }) {
    ...
    return /* @__PURE__ */ u2("div", { class: "center canvas-frame", children: [
      ...
      /* @__PURE__ */ u2("div", { class: "canvas-after-body", children: afterBody.map((BodyComponent) => renderSlot(BodyComponent)) })
    ] });
  }
};

export { CanvasBody_default as CanvasBody, CanvasFrame, CanvasPage, resolveEmbeddedHtml };
